...
from agents.reporting_agent_v12 import generate_grounded_report


# ============================================================
# MULTI-AGENT ORCHESTRATOR - VERSION 15
# DATA + CUSTOMER + CLAIM-VALIDATED RAG + REPORTING V12
# ============================================================
...
def is_successful_output(output: dict) -> bool:
    ...
    Version 15 preserves Version 14 success semantics.
...
def run_orchestrator(question: str):
    ...
    Structured analytical routes include:
        ...
        - Reporting Agent V12
        - Report Validator V17
        - claim-level report grounding validation
        - deterministic numeric / ranking validation
        - ordered multi-entity ranking validation
        - deterministic multi-entity revenue/value validation
        - count-specific grounding guardrails
        - negation-aware count validation
        - mixed-polarity count validation
        - recommendation guardrails
        - Markdown-aware report parsing
        - meta/control language filtering
    ...
    if selected_agent == "data_analyst":
        ...
        if analytical_result is None:
            ...
            return {
                ...
                "report_validation_attempts": None,
        ...
        print(
            ...
            "insights to Reporting Agent Version 12..."
        )

        reporting_output = generate_grounded_report(
            question=question,
            analytical_result=analytical_result,
            business_insights=business_insights,
        )

        executive_report = reporting_output.get(
            "executive_report"
        )
        ...
        return {
            ...
            "report_validation": reporting_output.get(
                "validation"
            ),
            "report_validation_attempts": reporting_output.get(
                "attempts"
            ),
            "research_result": None,
            "research_validation": None,
...
if __name__ == "__main__":
    ...
    for question in test_questions:
        ...
        # ====================================================
        # VERSION 15 FINAL SUCCESS VALIDATION
        # ====================================================
    ...
    print(
        "ORCHESTRATOR VERSION 15 TEST SUMMARY"
    )
