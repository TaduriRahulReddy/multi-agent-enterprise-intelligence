...
from agents.reporting_agent_v11 import generate_grounded_report


# ============================================================
# MULTI-AGENT ORCHESTRATOR - VERSION 14
# DATA + CUSTOMER + CLAIM-VALIDATED RAG + REPORTING V11
# ============================================================
...
def is_successful_output(output: dict) -> bool:
    ...
    Version 14 preserves Version 13 success semantics.
...
def run_orchestrator(question: str):
    ...
    if selected_agent == "data_analyst":
        ...
        print(
            ...
            "insights to Reporting Agent Version 11..."
        )
...
if __name__ == "__main__":
    ...
    for question in test_questions:
        ...
        # ====================================================
        # VERSION 14 FINAL SUCCESS VALIDATION
        # ====================================================
    ...
    print(
        "ORCHESTRATOR VERSION 14 TEST SUMMARY"
    )
