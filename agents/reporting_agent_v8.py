...
from tools.report_validator_v11 import validate_report


# ============================================================
# REPORTING AGENT - VERSION 8
#
# Changes from V7:
# - Uses Report Validator V11
# - Preserves the same generation / rewrite loop
# - Preserves the same fallback behavior
# - Retests the revenue-ranking integration failure from V7
# - Retests the repeat-customer count integration failure from V7
# - Verifies bold Markdown headings are parsed correctly
# - Verifies Markdown separators do not become factual claims
# - Verifies recommendations remain separate from factual claims
# - Verifies report-meta language does not trigger false rejection
# ============================================================
...
# ============================================================
# LOCAL TESTS - REPORTING AGENT VERSION 8
# ============================================================
...
if __name__ == "__main__":
    ...
    print(
        "Testing Reporting Agent Version 8"
    )
...
"""
    ...
    print(
        "REPORTING AGENT VERSION 8 TEST SUMMARY"
    )
