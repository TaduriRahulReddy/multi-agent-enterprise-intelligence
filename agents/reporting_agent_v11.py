...
from tools.report_validator_v16 import validate_report


# ============================================================
# REPORTING AGENT - VERSION 11
#
# Changes from V10:
#
# 1. Uses Report Validator V16.
#
...
#
# 4. Strengthens absolute-count reporting rules.
#
# 5. A repeat-customer count may establish ONLY the count
#    itself. It must not be interpreted as evidence of:
#
#       - loyalty strength
#       - retention strength
#       - engagement strength
...
#       - satisfaction
#
# 6. For count-only results, BUSINESS IMPLICATION should remain
#    neutral and preferably state what additional analysis is
#    required.
#
# 7. Rewrite instructions explicitly prevent replacement of one
#    unsupported count interpretation with another.
# ============================================================
...
# ============================================================
# LOCAL TESTS - REPORTING AGENT VERSION 11
# ============================================================
...
if __name__ == "__main__":
    ...
    print(
        "Testing Reporting Agent Version 11"
    )
...
"""
    ...
    print(
        "REPORTING AGENT VERSION 11 TEST SUMMARY"
    )
