...
from tools.report_validator_v4 import validate_report


# ============================================================
# REPORTING AGENT - VERSION 4
# STRICT GROUNDED REPORT GENERATION + CLAIM-LEVEL VALIDATION
# ============================================================
...
# ============================================================
# TEST REPORTING AGENT VERSION 4
# ============================================================
...
if __name__ == "__main__":
    ...
    print(
        "Testing Reporting Agent Version 4"
    )
    ...
    # Intentionally bad upstream insights.
    # Reporting Agent V4 must not blindly repeat them.
    test_insights = """
Key Finding:
There are 2,997 repeat customers.
