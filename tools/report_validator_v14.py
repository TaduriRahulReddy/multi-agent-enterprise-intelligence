...
# ============================================================
# REPORT VALIDATOR - VERSION 14
#
# V14 improvements over V13:
#
# 1. Preserves all V13 deterministic numeric/ranking logic.
#
# 2. Preserves ordered multi-entity revenue validation.
#
# 3. Adds negation-aware count guardrails.
#
# 4. Phrases such as:
#
#       "does not establish high retention"
#       "does not prove strong loyalty"
#       "cannot demonstrate strong retention"
#
#    are no longer treated as positive unsupported claims.
#
# 5. Mixed sentences still fail:
#
#       "This does not establish high retention,
#        but retention is high."
#
#    because the second assertion is still positive.
#
# 6. Unsupported positive claims continue to fail.
# ============================================================
...
# ============================================================
# V14 NEGATION-AWARE COUNT GUARDRAILS
# ============================================================
...
def unsupported_phrase_is_negated(
    ...
    """
    Determine whether a specific occurrence of an otherwise
    unsupported phrase is explicitly negated.
...
def contains_non_negated_phrase(
    ...
    """
    Return True when at least one occurrence of an unsupported
    phrase is asserted positively rather than explicitly
    negated.
    """
...
def looks_like_ordered_revenue_sequence(
    ...
    """
    Detect an ordered ranking statement.
    """
...
def deterministic_ordered_revenue_validation(
    ...
    """
    Validate ordered multi-entity revenue ranking sentences.
    """
...
def deterministic_revenue_claim_validation(
    ...
    """
    Validate revenue and rank claims using Python logic.
    """
...
8. An explicitly negated unsupported conclusion is acceptable.

Examples:

"This count does not establish high retention."

"This count does not prove strong customer loyalty."

These statements do NOT assert high retention or strong loyalty.

9. Numbers describing list size or structure are not metric
   values.
...
10. If a claim contains multiple factual assertions, every
    material assertion must be supported.

11. Human-readable transformations of column names are valid.
...
12. A single absolute count does not prove a trend.

13. When uncertain, return false.
...
def validate_report(
    ...
    return {
        ...
        "source": "hybrid_claim_validator_v14",
        "claim_results": claim_results,
        "recommendation_results": (
            recommendation_validation[
                "recommendation_results"
...
if __name__ == "__main__":
    ...
    print(
        "Testing Report Validator Version 14"
    )
    ...
    print(
        "\nTesting V14 numeric extraction"
    )
    ...
    print(
        "Testing V14 Markdown / numbered-list parser"
    )
...
"""
    ...
    print(
        "Testing V14 ordered revenue sequence logic"
    )
...
""",
    ...
    print(
        "REPORT VALIDATOR VERSION 14 TEST SUMMARY"
    )
