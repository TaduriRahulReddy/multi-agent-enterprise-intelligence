...
# + WARNING-FREE DOCSTRING CLEANUP
# ============================================================
...
def deterministic_count_check(
    ...
    """
    Prevent count-only data from supporting unsupported
...
def deterministic_revenue_ranking_check(
    ...
    behavioral or market interpretations.
    """
...
def claim_mentions_revenue(
    ...
    """
    Determine whether a claim discusses a revenue metric.
    """
...
def deterministic_revenue_claim_validation(
    ...
    If Python has enough structured information, the LLM is
...
def build_claim_validation_prompt(
    ...
    """
    Build the semantic validator prompt for claims that Python
    cannot safely verify directly.
    """
...
def parse_json_validation_response(
    ...
    """
    Parse the LLM claim-validation response.
    """
...
def validate_single_claim(
    ...
    Version 8 validation order:

    1. Try deterministic revenue/ranking validation.
    2. If Python can verify the claim, use that result.
    3. Otherwise use claim-level LLM validation.
    """
...
def recommendation_has_unsupported_premise(
    ...
    """
    Recommendations can propose further analysis or future
    actions, but cannot rely on unsupported factual premises.
    """
...
def validate_report(
    ...
    Version 8 keeps Version 7 behavior unchanged while
    removing the invalid escape-sequence warning from the
    previous documentation diagram.
    """
    ...
    return {
        ...
        "source": "hybrid_claim_validator_v8",
        "claim_results": claim_results,
        "recommendation_results": (
            recommendation_validation[
                "recommendation_results"
...
# ============================================================
# LOCAL TESTS - REPORT VALIDATOR VERSION 8
# ============================================================
...
if __name__ == "__main__":
    ...
    print(
        "Testing Report Validator Version 8"
    )
