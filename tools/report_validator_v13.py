...
# ============================================================
# REPORT VALIDATOR - VERSION 13
#
# V13 improvements over V12:
#
# 1. Preserves all V12 deterministic numeric/ranking logic.
#
# 2. Preserves all 27 V12 regression tests.
#
# 3. Fixes ordered multi-entity revenue statements such as:
#
...
#
#    V12 incorrectly found one entity in the sentence and
#    applied the word "highest" to that entity.
#
# 4. V13 identifies every known ranked entity in textual order
#    and verifies the ordered sequence against Python-owned
#    ranking records.
#
# 5. Correct sequence:
#
#       rank 1 -> Health & Beauty
#       rank 2 -> Watches & Gifts
#       rank 3 -> Bed & Bath & Table
#       rank 4 -> Sports & Leisure
#       rank 5 -> Computers & Accessories
#
#    is accepted deterministically.
#
# 6. Incorrect sequences remain rejected deterministically.
#
# 7. Single-entity ranking/value validation from V12 remains
#    unchanged.
# ============================================================
...
def parse_report_sections(
    ...
    - normalizing plain and Markdown headings,
    - supporting bold Markdown headings,
    - ignoring Markdown separators,
    - reconstructing wrapped prose,
    - preserving bullets as separate entries,
    - preserving numbered-list items separately.
    """
...
def is_meta_control_sentence(
    ...
    """
    Detect report-control/meta language.
    """
...
def find_entity_record_in_claim(
    ...
    """
    Find one entity mentioned in a factual claim.

    This is retained for V12-compatible single-entity claims.
    """
...
# ============================================================
# V13 MULTI-ENTITY ORDER HELPERS
# ============================================================
...
def find_all_entity_records_in_claim(
    ...
    """
    Find every known ranked entity appearing in a claim and
    return them in textual order.

    Example:

        "Health & Beauty is highest, followed by Watches &
         Gifts and Bed & Bath & Table."
...
def looks_like_ordered_revenue_sequence(
    ...
    """
    Determine whether a sentence makes an ordered ranking
    statement involving a highest/leading entity followed by
    additional entities.

    V13 intentionally scopes this narrowly so ordinary
    multi-entity prose continues to use the existing validator.
    """
...
def deterministic_ordered_revenue_validation(
    ...
    """
    Validate an ordered multi-entity revenue-ranking sentence.
    ...
    Expected mapping:
        ...
        Health & Beauty            -> rank 1
        Watches & Gifts            -> rank 2
        Bed & Bath & Table         -> rank 3
        Sports & Leisure           -> rank 4
        Computers & Accessories    -> rank 5

    The entities are matched according to their textual order,
    not by choosing one entity and applying "highest" to it.
    """
    ...
    # The first entity in a "highest ... followed by ..."
    # construction must be rank 1.
    expected_rank = 1
...
def deterministic_revenue_claim_validation(
    ...
    V13 first checks ordered multi-entity ranking sentences.

    If the sentence is not an ordered multi-entity sequence,
    the V12 single-entity logic is used unchanged.
    """
    ...
    # ========================================================
    # V13 ORDERED MULTI-ENTITY VALIDATION
    # ========================================================
...
def validate_report(
    ...
    return {
        ...
        "source": "hybrid_claim_validator_v13",
        "claim_results": claim_results,
        "recommendation_results": (
            recommendation_validation[
                "recommendation_results"
...
if __name__ == "__main__":
    ...
    print(
        "Testing Report Validator Version 13"
    )
    ...
    print(
        "\nTesting V13 numeric extraction"
    )
    ...
    print(
        "Testing V13 Markdown / numbered-list parser"
    )
...
"""
    ...
    # ========================================================
    # V13 DIRECT ORDERED-SEQUENCE DIAGNOSTICS
    # ========================================================
    ...
    print(
        "Testing V13 ordered revenue sequence logic"
    )
...
""",
    ...
    print(
        "REPORT VALIDATOR VERSION 13 TEST SUMMARY"
    )
