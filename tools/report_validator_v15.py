...
# ============================================================
# REPORT VALIDATOR - VERSION 15
#
# V15 improvements over V14:
#
# 1. Preserves all V14 deterministic revenue/ranking logic.
#
# 2. Preserves all V14 negation-aware count guardrails.
#
# 3. Adds deterministic validation for explicitly negated
#    count-only qualitative claims.
#
# 4. Safe examples:
#
#       "This does not establish high retention."
#       "This does not prove strong customer loyalty."
#       "The available count cannot establish strong retention."
#
#    are handled directly by Python and no longer sent to the
#    LLM validator.
#
# 5. Mixed statements remain unsafe:
#
#       "The count does not establish high retention,
#        but retention is high."
#
#    because the sentence still contains a positive unsupported
#    assertion.
#
# 6. This prevents the LLM from incorrectly rejecting a
#    correctly negated unsupported conclusion.
# ============================================================
...
# ============================================================
# V15 NEGATION-AWARE COUNT HELPERS
# ============================================================
...
def contains_negated_unsupported_count_phrase(
    ...
    """
    Return True if the claim contains at least one unsupported
    count phrase and every occurrence of that phrase is safely
    negated.
    """
...
def count_claim_has_positive_unsupported_assertion(
    ...
    """
    Detect positive unsupported count-only assertions.

    This includes both the configured phrase list and common
...
def deterministic_count_claim_validation(
    ...
    """
    Deterministically handle explicit negation of unsupported
    qualitative count conclusions.

    Python owns the semantic polarity here so the LLM cannot
    reject a correctly negated statement.

    Example:

        "This does not establish high retention."

    is valid because it explicitly states that the count is
    insufficient to establish retention strength.
    """
...
def validate_single_claim(
    ...
    V15 validation order:

    1. Count negation validator
    2. Revenue deterministic validator
    3. LLM semantic validator
    """

    # ========================================================
    # V15 COUNT NEGATION VALIDATION
    # ========================================================
...
def validate_report(
    ...
    return {
        ...
        "source": "hybrid_claim_validator_v15",
        "claim_results": claim_results,
        "recommendation_results": (
            recommendation_validation[
                "recommendation_results"
...
if __name__ == "__main__":
    ...
    print(
        "Testing Report Validator Version 15"
    )
    ...
    print(
        "\nTesting V15 numeric extraction"
    )
    ...
    print(
        "Testing V15 Markdown / numbered-list parser"
    )
...
"""
    ...
    print(
        "Testing V15 ordered revenue sequence logic"
    )
...
""",
    ...
    print(
        "REPORT VALIDATOR VERSION 15 TEST SUMMARY"
    )
