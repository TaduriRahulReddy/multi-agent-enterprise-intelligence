...
# ============================================================
# REPORT VALIDATOR - VERSION 16
#
# V16 improvements over V15:
#
# 1. Preserves all deterministic numeric/ranking logic.
#
# 2. Preserves ordered multi-entity revenue validation.
#
# 3. Preserves negation-aware count validation.
#
# 4. Adds mixed-polarity / contrast-clause detection.
#
# 5. Safe:
#
#       "This does not establish high retention."
#
#       "The count does not prove strong customer loyalty."
#
...
#
#    The positive assertion after "but" is detected and rejected.
#
# 7. Contrast markers handled include:
#
#       but
#       however
#       yet
...
def unsupported_phrase_is_negated(
    ...
    V16 prevents negation from leaking across commas or major
    clause boundaries.
    """
...
def contrast_clause_has_positive_unsupported_assertion(
    ...
    This prevents a safe negation in the first clause from
    hiding an unsupported positive statement in a later clause.
    """
    ...
    # Examine clauses after the first contrast boundary.
...
def contains_negated_unsupported_count_phrase(
    ...
    count phrase and all occurrences of those phrases are safely
    negated.
    """
...
def deterministic_count_claim_validation(
    ...
    V16 also checks contrast clauses so a safe negation cannot
    hide a later unsupported positive assertion.
    """
    ...
    # --------------------------------------------------------
    # Positive unsupported assertion
    # --------------------------------------------------------
...
def deterministic_count_check(
    ...
    for claim in factual_claims:
        ...
        # V16 mixed-polarity report-level check.
        if contrast_clause_has_positive_unsupported_assertion(
            claim
        ):
...
def validate_single_claim(
    ...
    # ========================================================
    # COUNT NEGATION / POLARITY VALIDATION
    # ========================================================
...
def validate_report(
    ...
    return {
        ...
        "source": "hybrid_claim_validator_v16",
        "claim_results": claim_results,
        "recommendation_results": (
            recommendation_validation[
                "recommendation_results"
...
if __name__ == "__main__":
    ...
    print(
        "Testing Report Validator Version 16"
    )
    ...
    print(
        "\nTesting V16 numeric extraction"
    )
    ...
    print(
        "Testing V16 Markdown / numbered-list parser"
    )
...
"""
    ...
    print(
        "Testing V16 ordered revenue sequence logic"
    )
...
""",
    ...
    print(
        "REPORT VALIDATOR VERSION 16 TEST SUMMARY"
    )
