...
# ============================================================
# REPORT VALIDATOR - VERSION 11
#
# V11 improvements over V10:
#
# 1. Preserves all V10 deterministic numeric/ranking logic.
#
# 2. Recognizes additional Markdown section-heading formats:
#
#       **EXECUTIVE SUMMARY**
#       **KEY RESULTS**
...
#       ## **EXECUTIVE SUMMARY**
#
# 3. Ignores Markdown horizontal separators:
#
#       ---
#       ***
#       ___
#
# 4. Filters pure report-description/meta language such as:
#
#       "This report provides an overview..."
#       "This report provides an analysis..."
#
#    These describe the report rather than asserting business
#    facts from the analytical result.
#
# 5. Prevents recommendations under bold Markdown headings
#    from leaking into factual-claim validation.
#
# 6. Preserves deterministic validation for unsupported:
#    - loyalty / retention interpretations
#    - demand / interest interpretations
#    - rankings
#    - revenue values
...
def normalize_section_header(
    ...
    # --------------------------------------------------------
    # Remove trailing Markdown heading hashes.
    # --------------------------------------------------------
    ...
    # --------------------------------------------------------
    # Remove bold Markdown wrappers only if they wrap the
    # whole line.
    #
    # This does not alter:
    #
    ...
    #
    # because the complete line is not wrapped.
    # --------------------------------------------------------
...
def parse_report_sections(
    ...
    for raw_line in executive_report.splitlines():
        ...
        # ----------------------------------------------------
        # V11: ignore Markdown horizontal separators.
        # ----------------------------------------------------
        ...
        # ----------------------------------------------------
        # Normalize plain / Markdown / bold Markdown headings.
        # ----------------------------------------------------
        ...
        # ----------------------------------------------------
        # Text before a recognized heading.
        # ----------------------------------------------------
...
def is_meta_control_sentence(
    ...
    """
    Detect report-control/meta language that should not be
    treated as a business factual claim.

    V11 adds report-description statements such as:
    ...
    # --------------------------------------------------------
    # Existing control/meta language.
    # --------------------------------------------------------
    ...
    # --------------------------------------------------------
    # V11:
    # Pure statements describing the report itself.
    # --------------------------------------------------------
...
def validate_report(
    ...
    Validation flow:
        ...
        Markdown Header Normalization
              |
        Bold Header Normalization
              |
        Markdown Separator Filtering
              |
    ...
    return {
        ...
        "source": "hybrid_claim_validator_v11",
        "claim_results": claim_results,
        "recommendation_results": (
            recommendation_validation[
                "recommendation_results"
...
if __name__ == "__main__":
    ...
    print(
        "Testing Report Validator Version 11"
    )
    ...
    print(
        "\nTesting V11 numeric extraction"
    )
    ...
    print(
        "Testing V11 Markdown / numbered-list parser"
    )
...
""",
    ...
    print(
        "REPORT VALIDATOR VERSION 11 TEST SUMMARY"
    )
