...
# ============================================================
# REPORT VALIDATOR - VERSION 12
#
# V12 improvements over V11:
#
# 1. Preserves all V11 deterministic numeric/ranking logic.
#
# 2. Preserves support for:
...
#    - Markdown separators
#
# 3. Expands report/meta-control filtering for phrases such as:
#
#       "This executive report provides..."
#
...
#
# 4. These cautious analysis statements are not treated as
#    business facts because they do not assert that the
#    underlying relationship actually exists.
#
# 5. Unsupported factual claims must still fail, including:
#
#       "The company has strong retention."
#       "The count shows a positive trend."
...
def is_meta_control_sentence(
    ...
    V12 expands V11 handling for:
    - executive-report description language
    - cautious "further analysis may be required" language
    """
    ...
    # --------------------------------------------------------
    # Existing and V12 analysis-control language.
    # --------------------------------------------------------
...
def validate_report(
    ...
    return {
        ...
        "source": "hybrid_claim_validator_v12",
        "claim_results": claim_results,
        "recommendation_results": (
            recommendation_validation[
                "recommendation_results"
...
if __name__ == "__main__":
    ...
    print(
        "Testing Report Validator Version 12"
    )
    ...
    print(
        "\nTesting V12 numeric extraction"
    )
    ...
    print(
        "Testing V12 Markdown / numbered-list parser"
    )
...
""",
    ...
    print(
        "REPORT VALIDATOR VERSION 12 TEST SUMMARY"
    )
